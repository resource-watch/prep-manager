        ...
        {tab === 'embed' ?
          ...
          (<div className="media">
            <a href={`http://www.facebook.com/sharer/sharer.php?u=${window.location.href}`} target="_blank">
              <svg width="8.4" height="19" viewBox="0 0 8 16"><title>facebook</title><path d="M7.172 5.18H4.728V3.52c0-.623.403-.767.679-.767h1.727V.011L4.76 0C2.124 0 1.523 2.047 1.523 3.354v1.827H0v2.825h1.523V16h3.205V8.006h2.163l.281-2.825" fillRule="evenodd" /></svg></a>
