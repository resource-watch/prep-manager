...
class MyPREPEditProfile extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="c-myprep-edit-profile">
...
export default connect(mapStateToProps, null)(MyPREPEditProfile);
