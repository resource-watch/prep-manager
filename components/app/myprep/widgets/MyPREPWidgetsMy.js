...
class MyPREPWidgetsMy extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="c-myprep-widgets-my">
        <div className="row">
          <div className="column small-12">
            <div className="list-actions">
              <div className="left-container">
                <button
                  className="c-btn -app"
                  onClick={() => Router.pushRoute('admin_myprep_detail', { tab: 'widgets', id: 'new' })}
                >
                  New widget
                </button>
...
export default connect(mapStateToProps, null)(MyPREPWidgetsMy);
