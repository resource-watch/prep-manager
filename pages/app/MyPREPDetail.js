...
// import LayersTab from 'components/app/myprep/layers/LayersTab';

// Components
import Title from 'components/ui/Title';

class MyPREPDetail extends Page {
  constructor(props) {
    super(props);
            ...
            <div className="row">
              <div className="column small-12">
                <div className="page-header-content">
                  <Breadcrumbs
                    items={[{ name: capitalizeFirstLetter(tab), route: 'myprep', params: { tab } }]}
                  />
                  ...
                  {myprepdetail.dataset &&
                    <div className="page-header-info">
                      <ul>
                        <li>Dataset: <Link route="explore_detail" params={{ id: myprepdetail.dataset.id }}><a>{myprepdetail.dataset.name}</a></Link></li>
                      </ul>
                    </div>
                  }
                </div>
